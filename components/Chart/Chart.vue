...
useHead({
  script: [
    ...
    {
      src: "https://www.amcharts.com/lib/4/geodata/worldLow.js",
    },
    {
      src: "https://covid.amCharts.com/data/js/world_timeline.js",
    },
    {
      src: "https://covid.amCharts.com/data/js/total_timeline.js",
    },
    {
...
onMounted(() => {
  am4core.ready(function () {
    ...
    am4core.ready(function () {
      ...
      mapChart.backgroundSeries.mapPolygons.template.polygon.fill =
      ...
      slider.events.on("rangechanged", function (event) {
        var index = Math.round(
          (covid_world_timeline.length - 1) * slider.start
        );
      ...
      sizeSlider.startGrip.background.states.getKey("hover").properties.fill =
        activeColor;
      sizeSlider.startGrip.background.states.getKey("down").properties.fill =
        activeColor;
      ...
      filterSlider.startGrip.background.states.getKey("hover").properties.fill =
        activeColor;
      filterSlider.startGrip.background.states.getKey("down").properties.fill =
        activeColor;
