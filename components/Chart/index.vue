...
useHead({
	script: [
		{ src: "https://covid.amcharts.com/deps/amcharts4/core.js" },
		{ src: "https://covid.amcharts.com/deps/amcharts4/charts.js" },
		{ src: "https://covid.amcharts.com/deps/amcharts4/maps.js" },
		{
			src: "https://covid.amcharts.com/deps/amcharts4/themes/animated.js",
		},
		{
			src: "https://covid.amcharts.com/deps/amcharts4-geodata/worldLow.js",
		},
		{
			src: "https://covid.amcharts.com/deps/amcharts4-geodata/data/countries2.js",
		},
		{
			src: "https://covid.amcharts.com/data/js/world_timeline.js?ts=1595345227",
		},
		{
			src: "https://covid.amcharts.com/data/js/total_timeline.js?ts=1595345227",
		},
	],
});
...
onMounted(() => {
  ...
  dateAxis.renderer.labels.template.adapter.add("fillOpacity", function(fillOpacity, target){
      return dateAxis.valueToPosition(target.dataItem.value) + 0.1;
			...
			am4core
				.getInteraction()
				.body.events.off("down", lineChart.cursor.handleCursorDown, lineChart.cursor);
			am4core
				.getInteraction()
			...
			function updateCountryName() {
				countryName.text =
					currentCountry + ", " + mapChart.dateFormatter.format(currentDate, "MMM dd, yyyy");
			}
					...
					for (var key in buttons) {
						...
						if (!isNaN(count)) {
							buttons[key].label.text =
								capitalizeFirstLetter(key) + ": " + numberFormatter.format(count, "#,###");
						}
					}
					currentIndex = index;
				}
