<template>
  <nuxt-link to="https://www.amcharts.com/" target="_blank" rel="noopener noreferrer">
    <li>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 86 50">
        ...
        <path
          ...
          stroke-linejoin="round"
          stroke-miterlimit="10"
          d="M83.4 25h-31C37 25 39.5 4.4 28.4 4.4S18.9 24.2 4.3 25H1.7"
        />
        <path
          fill="none"
          stroke="#3CABFF"
